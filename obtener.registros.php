...
foreach($resultado as $fila){
    ...
    $sub_array[] = '<button type="button" name="editar" id="'.$fila["codigo_estudiante"].'"  class="btn btn-secondary btn-xs editar">Editar</button>';
    $sub_array[] = '<button type="button" name="editar" id="'.$fila["codigo_estudiante"].'"  class="btn btn-danger btn-xs borrar">Borrar</button>';
    $datos[] = $sub_array;
